...
public class WalmartStepDefinitions {
    ...
    public void kullanici_wallmart_anasayfaya_gider() {
        Driver.getDriver().get(ConfigReader.getProperty("walmart_url"));
    }

    @Then("walmart sayfasinda {string} icin arama yapar")
    public void walmart_sayfasinda_icin_arama_yapar(String kelime) {
        walmartPage.walmartAramaKutusu.sendKeys(kelime + Keys.ENTER);
    }
